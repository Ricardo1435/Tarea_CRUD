<%-- 
    Document   : edit
    Created on : 22/10/2020, 10:46:32 AM
    Author     : Ricardo
--%>
...
<html>
    <head>
        ...
        <!-- Enlazando a los archivos de JS-->
    ...
    <body>
       <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <form class="bg-light container-md mt-5 mb-5 " action="Controlador" method="POST">
            <center><h2 class="mt-2 mb-2"> EDITOR DE REGISTROS &nbsp;&nbsp;&nbsp;<i class="fas fa-user-edit"></i></h2> </center>
            <div>
                <input type="hidden" class="form-control" name="ingresoID" value="${producto.getID()} " required="">
            </div>
            <div>
                <b><label for="ingresoNombre">Nombre</label></b>
                <input type="text" autocomplete="off" class="form-control" name="ingresoNombre"  value="${producto.getNombre()}" required="">
            </div>
            <div>
                <b><label for="ingresoExistencia" class="mt-2">Existencia</label></b>
                <input type="text" autocomplete="off" class="form-control" name="ingresoExistencia" value="${producto.getExistencia()}" required>
            </div>
            <div>
                <b><label for="ingresoPrecio" class="mt-2">Precio</label></b>
                <input type="text" autocomplete="off" class="form-control" name="ingresoPrecio"  value="${producto.getPrecio()}" required>
            </div>
            <div>
                <b><label for="ingresoCaducidad" class="mt-2">Caducidad</label></b>
                <input type="text" autocomplete="off" class="form-control" name="ingresoCaducidad"  value="${producto.getCaducidad()}">
            </div>
           <div>
